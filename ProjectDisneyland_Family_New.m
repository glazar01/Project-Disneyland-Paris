...
for k = 1 : 3
    ...
    RateGroup1 = 2;         % Rate for Age1        
    RateGroup2 = 4;         % Rate for Age2 (for phase 2)
    RateGroup3 = 5;         % Rate for Age3
    RateGroup4 = 7;         % Rate for Age1 + Age3 (for phase 1)
    ...
    Ratings = csvread('RatingsModified3.csv');      % Columns: Preschoolers | Kids | Tweens | Teens | Adults | Kid+Teen+Adult | Kid & Adults | Preschooler & Adult | Teen & Kid | Tween & Adult | Preschooler&Teen&Adult | Preschooler&Kid&Teen&Adult | Preschooler+Tween+Adult | Kid&Tween&Adult
    ...
    %AgeRes4 = AgeR(Age4,1:N); ------ ONLY FOR THE USE OF 3RD EXPERIMENT!!
